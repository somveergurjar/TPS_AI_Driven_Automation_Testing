...
- Name: TPS_addEquipment_Flow\happy_path_scenarios\happy-path-scenarios-tests.spec.ts >> Happy Path Scenarios >> TC-35: Equipment Creation with Status Changed to OBSOLETE
- Location: tests\TPS_addEquipment_Flow\happy_path_scenarios\happy-path-scenarios-tests.spec.ts:108:7
