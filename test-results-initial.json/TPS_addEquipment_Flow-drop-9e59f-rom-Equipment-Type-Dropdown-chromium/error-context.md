...
- Name: TPS_addEquipment_Flow\dropdown_tests\dropdown-functionality-tests.spec.ts >> Dropdown Functionality Tests >> TC-30: Verify Can Select from Equipment Type Dropdown
- Location: tests\TPS_addEquipment_Flow\dropdown_tests\dropdown-functionality-tests.spec.ts:98:7
...
Locator: locator('select:nth-of-type(3)')
Expected: "SELECT..."
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('select:nth-of-type(3)')
