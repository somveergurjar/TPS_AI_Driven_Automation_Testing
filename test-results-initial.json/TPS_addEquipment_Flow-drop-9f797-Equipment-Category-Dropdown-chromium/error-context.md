...
- Name: TPS_addEquipment_Flow\dropdown_tests\dropdown-functionality-tests.spec.ts >> Dropdown Functionality Tests >> TC-29: Verify Can Select from Equipment Category Dropdown
- Location: tests\TPS_addEquipment_Flow\dropdown_tests\dropdown-functionality-tests.spec.ts:72:7
...
Locator: locator('select:nth-of-type(2)')
Expected: "SELECT..."
Timeout: 5000ms
