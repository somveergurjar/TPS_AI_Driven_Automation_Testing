...
- Name: TPS_addEquipment_Flow\happy_path_scenarios\happy-path-scenarios-tests.spec.ts >> Happy Path Scenarios >> TC-33: Equipment Creation with All Fields Including Optional Ones
- Location: tests\TPS_addEquipment_Flow\happy_path_scenarios\happy-path-scenarios-tests.spec.ts:46:7
