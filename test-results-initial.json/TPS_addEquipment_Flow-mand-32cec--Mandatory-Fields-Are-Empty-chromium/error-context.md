...
- Name: TPS_addEquipment_Flow\mandatory_field_validation\mandatory-field-validation-tests.spec.ts >> Mandatory Field Validation Tests >> TC-13: Verify Save Is Prevented When Mandatory Fields Are Empty
- Location: tests\TPS_addEquipment_Flow\mandatory_field_validation\mandatory-field-validation-tests.spec.ts:102:7
...
Locator: locator('[aria-label="Auto-generated"]')
Expected: visible
Timeout: 5000ms
    ...
    - main [ref=e74]:
      - generic [ref=e76]:
        ...
        - generic [ref=e184]:
          ...
          - button "Save Equipment" [active] [ref=e186] [cursor=pointer]:
            - img [ref=e187]
            - text: Save Equipment
```
